...
public class LoginActivity extends AppCompatActivity {
        ...
        tvSubmit.setOnClickListener (new View.OnClickListener () {
            ...
            public void onClick (View view) {
                ...
                if (etUsername.getText ().toString ().trim ().length () == 0) {
                    ...
                    sendLoginCredentialsToServer (etUsername.getText ().toString (), etPassword.getText ().toString (), jsonDeviceDetails.toString ());
                }
            }
        });
    ...
    private void sendLoginCredentialsToServer (final String username, final String password, final String device_details) {
                            ...
                            if (response != null) {
                                try {
                                    ...
                                    if (! error) {
                                        ...
                                        userDetailsPref.putStringPref (LoginActivity.this, UserDetailsPref.COMPANY_ID, jsonObj.getString (AppConfigTags.USER_COMPANY_ID));
                                        userDetailsPref.putStringPref (LoginActivity.this, UserDetailsPref.COMPANY_NAME, jsonObj.getString (AppConfigTags.USER_COMPANY_NAME));
                                        userDetailsPref.putStringPref (LoginActivity.this, UserDetailsPref.PARTY_ID, jsonObj.getString (AppConfigTags.USER_PARTY_ID));
                                        userDetailsPref.putStringPref (LoginActivity.this, UserDetailsPref.PARTY_NAME, jsonObj.getString (AppConfigTags.USER_PARTY_NAME));
